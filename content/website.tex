\section{website}
  ...
  \subsection{Flask}
    ...
    \subsubsection{template inheritance}
      ...
      \begin{codeblock}[language=html, caption={layout.html}]
        <head>
            {% if title %}
      ...
      \begin{codeblock}[language=html, caption={Using template inheritance}]
        {% extends "layout.html" %} 
        {% block content %}
    ...
    \subsubsection{bootstrap}
      ...
      \begin{codeblock}[language=html, caption={bootstrap}]
        <!doctype html>
        <html lang="en">
        <head>
            <meta charset="utf-8">
    ...
    \subsubsection{External CSS}
      ...
      \begin{codeblock}[language=HTML, caption={static/main.css}]
    ...
    \subsubsection{post data}
      ...
      \begin{codeblock}[language=html, caption={use posts in html}]
        <head>
            {% if title %}
                <title>My app - {{ title }}</title>
            {% else %}
    ...
    \subsubsection{form \& field}
      ...
      \begin{codeblock}[language=html, caption={layout.html}]
        {% with messages = get_flashed_messages(with_categories=true) %} <!--success就是true-->
            {% if messages %}
    ...
    \subsubsection{flask-sqlalchemy}
      ...
      \begin{codeblock}[language=python, caption={Using sqlalchemy in models.py}]
        ...
        class User(db.Model): #创建一个User表
            ...
            username = db.Column(db.String(20), unique=True, nullable=False) #用户名不重复且不为空
            email = db.Column(db.String(120), unique=True, nullable=False) 
            image_file = db.Column(db.String(20), nullable=False, default='default.jpg') 
                #图片用hash值记录
            password = db.Column(db.String(60), nullable=False) #密码用hash值记录
            posts = db.relationship('Post', backref='auther', lazy=True) #记录Post和User的关系
        ...
        class Post(db.Model): #创建一个Post表
            ...
            date_posted = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
                #注意这里utcnow是一个函数而不是函数的返回值，否则default会立即调用，生成一个固定的时间
    ...
    \subsubsection{FileField}
      ...
      在html文件中调用FileField。
      \begin{codeblock}[language=html, caption={Using FileField in html}]
    ...
    \subsubsection{Pagination}
      ...
      \begin{codeblock}[language=html, caption={Using pagination in home.html}]
