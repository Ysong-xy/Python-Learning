\section{Website}
  ...
  \subsection{处理html文件}
    ...
    \begin{codeblock}[language=python, caption={Handling HTML}]
      ...
      soup = BeautifulSoup(source, 'lxml', from_encoding='utf-8') #从网页上获取文件
      ...
      match_re = soup.find_all('a', href=re.compile(r'http://.*')) #正则表达式查找
      match_cls = soup.find_all('div', class_='footer') #查找文件中所有对应的内容，返回一个列表
    \end{codeblock}
