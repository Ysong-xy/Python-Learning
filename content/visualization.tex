\section{Visualization}
  ...
  \subsection{matplotlib}
    \subsubsection{画布预处理}
      \begin{codeblock}[language=python, caption={basic setup of plt}]
        ...
        plt.table(cellText=params, colLabels=["Parameter", "Value"], bbox=[0.6, 0.4, 0.35, 0.4])
          #添加表格，bbox的参数为[x0, y0, width, height]
  ...
  \subsection{tensorboard}
    ...
    可以在终端中查看tensorboard的运行情况：
    \begin{codeblock}[language={bash}, caption={tensorboard}]
